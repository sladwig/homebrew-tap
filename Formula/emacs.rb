class Emacs < Formula
  ...
  if build.with? "no-frame-refocus"
    patch do
      url Emacs.get_resource_url("patches/0001-No-frame-refocus-cocoa.patch")
  ...
  if build.with? "pdumper"
    patch do
      url Emacs.get_resource_url("patches/0003-Pdumper-size-increase.patch")
  ...
  patch do
    url Emacs.get_resource_url("patches/0005-System-appearance.patch")
    sha256 "2a0ce452b164eee3689ee0c58e1f47db368cb21b724cda56c33f6fe57d95e9b7"
  end

  patch do
    url Emacs.get_resource_url("patches/0008-Fix-window-role.patch")
